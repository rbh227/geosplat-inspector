...
If you're using Claude Code (or another agentic coding tool) on this repo, the
sections above are the load-bearing context: architecture, boundary map, and
build/test commands. There's no project-specific skill routing here — use
whatever general-purpose workflow your tool provides for planning, review, and
shipping changes.
