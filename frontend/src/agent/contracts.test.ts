...
describe('contracts v0.2 mirror', () => {
  it('matches the Python registry counts (24 frontend / 18 backend)', () => {
    // v0.3 added `turn`, v0.4 added `reframe` (both frontend): 22 -> 24.
    expect(FRONTEND_TOOLS.length).toBe(24)
